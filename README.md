...
A leitura é pública por link e mantém uma única liderança CMO/COO. A entrada oferece dois modos complementares: **JARVIS**, que cumprimenta, resume o estado da carteira e conduz a liderança por uma sequência de atenção e decisão; e **ANALISTA**, que permite investigar causas, evidências, fluxo e itens afetados. Nenhum modo altera status, cria demanda ou substitui o Vybe Painel.

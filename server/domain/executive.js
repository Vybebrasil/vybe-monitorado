...
export function buildExecutiveSnapshot({ bottlenecks = {}, posts = {}, demands = [], calendar = null, meetingLogs = [], generatedAt = new Date().toISOString(), sourceMeta = {} }) {
  ...
  return {
    ...
    sourceQuality: {
      ...
      source: sourceMeta.name || 'Monday.com',
      mirrorVersion: sourceMeta.mirrorVersion ?? sourceMeta.sync?.version ?? null,
      versionScope: sourceMeta.versionScope || (sourceMeta.mirrorReady ? 'production-mirror' : 'fallback-direct'),
      versionMonitor: sourceMeta.versionMonitor || sourceMeta.sync?.versionMonitor || null,
      consistency: sourceMeta.consistency || null,

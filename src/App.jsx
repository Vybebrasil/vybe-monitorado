...
function ManagerStation({ snapshot, history, timeSeries, intelligence, onExit, onOpenAnalyst, onOpenZen, onRefresh, refreshing, refreshError }) {
  ...
  return (
    <>
      ...
      {appMode === 'zen' && (
        <Suspense fallback={(
          <div className="loading-wrapper">
            <div className="loading-text">Carregando Zen Mode</div>

...
import { auditProfile } from './_scraper-module.js';
import mondayIntegration from './_integrations/monday.js';
import { getFutureMeetings } from './_integrations/calendar.js';
import { buildExecutiveSnapshot } from './_domain/executive.js';
import { listDecisionRecords, saveDecisionRecord, updateDecisionRecord } from './_domain/executive-records.js';
import { createVersionedAuditRecord } from './_domain/audit-records.js';
import { buildClientHealthScore } from './_domain/health-score.js';
import { listExecutiveSnapshots, saveExecutiveSnapshot, summarizeSnapshotTrend } from './_domain/executive-snapshots.js';
import { listImpactRecords, saveImpactRecord, updateImpactRecord } from './_domain/impact-records.js';
import { listHealthSnapshots, saveHealthSnapshot, summarizeHealthTrend } from './_domain/health-snapshots.js';
import { summarizeDecisionEffectiveness, detectPersistentRisks, summarizePortfolioPatterns, buildExecutiveBriefing } from './_domain/decision-analytics.js';
import { buildExecutiveBriefingDocument } from './_domain/executive-briefing.js';
import { buildExecutiveAlerts } from './_domain/executive-alerts.js';
import { buildDecisionMemory, buildExecutiveScenarios } from './_domain/executive-planning.js';
import { buildOutcomeLearning } from './_domain/outcome-learning.js';
